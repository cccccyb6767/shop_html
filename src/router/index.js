      ...
      redirect: '/test'
    },
        {
          ...
          children: [
            ...
            {
              path: '/Attr',
              component: () => import(/* webpackChunkName: "dashboard" */ '../components/attribute/Attr.vue'),
              meta: { title: '属性管理' }
            },
            {
              path: '/addProduct',
              component: () => import(/* webpackChunkName: "dashboard" */ '../components/addProduct/AddProduct.vue'),
              meta: { title: '商品管理' }
            },
